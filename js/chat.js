  ...
  function renderWelcomeScreen() {
    return `
      <div class="chat-welcome">
        ...
        <!-- ChatGPT Gratis Card -->
        <div class="chatgpt-free-card" onclick="Chat.openChatGPT()">
          <div class="chatgpt-free-icon">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
            </svg>
          </div>
          <div class="chatgpt-free-info">
            <div class="chatgpt-free-title">
              <span>Buka ChatGPT Gratis</span>
              <span class="chatgpt-free-badge">GRATIS</span>
            </div>
            <div class="chatgpt-free-desc">Langsung chat di chatgpt.com tanpa API Key — buka di tab baru</div>
          </div>
          <div class="chatgpt-free-arrow">
        ...
        <div class="chat-divider-or">
          <span>atau gunakan AI Chat bawaan</span>
        </div>
